...
mytheme = list(
  theme_classic()+
    theme(panel.background = element_blank(),strip.background = element_rect(colour=NA, fill=NA),panel.border = element_rect(fill = NA, color = "black"),
          legend.title = element_text(face="plain", size=20),legend.text = element_text(face="plain", size=20), legend.position="bottom", strip.text = element_text(face="plain", size=20),
          axis.text=element_text(face="plain", size=20),axis.title = element_text(face="plain", size=20),plot.title = element_text(face = "bold", hjust = 0.5,size=20))
)
