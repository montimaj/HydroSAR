...
tpgw_raster1 <- raster('C:/Users/sayan/PycharmProjects/HydroSAR/Outputs/Output_AZ_Apr_Sept/Subsidence_Analysis/MPGW/MPGW_2004_2010.tif')
ls_raster1 <- raster('C:/Users/sayan/PycharmProjects/HydroSAR/Outputs/Output_AZ_Apr_Sept/Subsidence_Analysis/Subsidence_GW/2004_2010/MS_2004_2010.tif')

tpgw_raster2 <- raster('C:/Users/sayan/PycharmProjects/HydroSAR/Outputs/Output_AZ_Apr_Sept/Subsidence_Analysis/MPGW/MPGW_2010_2018.tif')
ls_raster2 <- raster('C:/Users/sayan/PycharmProjects/HydroSAR/Outputs/Output_AZ_Apr_Sept/Subsidence_Analysis/Subsidence_GW/2010_2018/MS_2010_2018.tif')
...
plot(tpgw_raster2, xlab='Longitude (Degree)', ylab='Latitude (Degree)', legend.args=list(text='Predicted GW Pumping (cm/yr)', side = 2, font = 1, cex = 1), col=col, box=F, axes=F, ext=plot_ext)
axis(side=2, at=c(31:37))
axis(side=1, at=c(-115:-109))

col <- rev(brewer.pal(n=7, name='Reds'))
plot(ls_raster2, xlab='Longitude (Degree)', ylab='Latitude (Degree)', legend.args=list(text='Land Subsidence (cm/yr)', side = 2, font = 1, cex = 1), col=col, box=F, axes=F, ext=plot_ext)
axis(side=2, at=c(31:37))
axis(side=1, at=c(-115:-109))
